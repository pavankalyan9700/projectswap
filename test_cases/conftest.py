...
def pytest_addoption(parser):
    parser.addoption("--browser", action="store", default="chrome", help="Specify the bowser: chrome or firefox or edge")
...
def pytest_configure(config):
    config.stash[metadata_key]['Project Name'] = 'Youtube Project, swap'
